...
ActiveRecord::Schema.define(version: 2021_08_21_074916) do
  ...
  create_table "line_foods", force: :cascade do |t|
    t.integer "food_id"
    t.integer "resutaurant_id", null: false
    t.integer "order_id"
    ...
    t.index ["resutaurant_id"], name: "index_line_foods_on_resutaurant_id"
  end
  ...
  add_foreign_key "line_foods", "resutaurants"
end
